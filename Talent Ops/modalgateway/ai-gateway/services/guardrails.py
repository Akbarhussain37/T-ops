...
class GuardrailService:
    ...
    def should_answer(
        ...
        if num_chunks < 2:
            return {
                "should_answer": False,
                "reason": "Insufficient source material (need 2+ chunks)"
            }
        
        # Single source needs higher confidence
        if unique_docs < 2 and confidence < 0.85:
            return {
                "should_answer": False,
                "reason": "Single source requires confidence >= 0.85"
            }
